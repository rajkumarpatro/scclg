<%@ Page Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="department_events_details.aspx.cs" Inherits="department_events_details" Title="Upcoming Department Events" %>
...
<div class="wrap-title-page">
					<div class="container">
						<div class="row">
							<div class="col-xs-12"><h1 class="ui-title-page">Department Event- <asp:Label ID="lbl_title" runat="server"></asp:Label></h1></div>
						</div>
					</div><!-- end container-->
							...
							<div class="col-xs-12">
								<div class="wrap-breadcrumb clearfix">
									<ol class="breadcrumb">
										...
										<li class="active">Departments Event</li>
									</ol>
								</div>
							</div>
						</div>
    ...
    <section >
      <div class="container">
         <div class="section-content">
             <div class="row">
                 <div class="col-md-12">
                     <h6 class="letter-space-4 text-gray-darkgray text-uppercase mt-0 mb-0">Photo Gallery</h6>
                    <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Photo Gallery: <asp:Label ID="lbl_event" runat="server"></asp:Label></h2>
                 </div>
             </div>
              ...
              <div class="row">
                 <div class="col-lg-4 col-md-4 col-sm-12">
                     <figure><asp:Image ID="img_caption" runat="server" CssClass="img-responsive"></asp:Image></figure>
                 </div>
              ...
              <div class="row">
                 <div class="col-lg-12 col-md-12 col-sm-12">
                    <span id="span_story_details" runat="server"></span>
                 </div>
              </div>
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                        <span id="desc_content1" runat="server"></span>
                  </div>
              </div>
           </div>
       </div>             
