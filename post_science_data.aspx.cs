...
public partial class post_science_data : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            if (Session["iamuser"] != null)
            {
                ...
                if (Session["iamuser"].ToString() != "scdurg")
                {
                    ...
                    ddl_pagehead.SelectedValue = dt_data.Rows[0]["PAGE_HEAD_ID"].ToString();
                    GetSubMenu();
                    ddl_submenu.SelectedValue = dt_data.Rows[0]["PAGE_ID"].ToString();
                    GetTopics();
        ...
        if (flag == 1)
        {
            ...
            if (allok == 0)
            {
                ...
                if (lbl_Id.Text != "")
                {
                    ...
                    sp[2].Value = Server.HtmlDecode(txt_description.InnerText);
                ...
                else
                {
                    ...
                    sp[4].Value = Server.HtmlDecode(txt_description.InnerText);
    ...
    protected void imgbtn_edit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            txt_description.InnerText = Server.HtmlDecode(dt_data.Rows[0]["TOPIC_DESCRIPTION"].ToString());
