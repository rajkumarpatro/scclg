<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadPhotos.aspx.cs" Inherits="photo_upload" %>
        ...
        <tr>
            <td width="20%" 
                ...
                <asp:GridView ID="gw_pics" runat="server"  
                                                                    Width="100%" AutoGenerateColumns="False" EnableModelValidation="True" DataKeyNames="SUB_TOPIC_ID,PHOTO_ID">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="SUB_TOPIC_ID" HeaderText="ID" Visible="False"></asp:BoundField>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Photo" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <img src="<%# Eval("PHOTO_PATH") %>" width="100" height="60" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImageButton1" runat="server" 
                                                                                    ...
                                                                                    OnClientClick="return confirm('Do you want to delete Family Member Details? ');" OnClick="imgbtn_delete_Click" />
                                                                            </ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Delete All" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImageButton3" runat="server" 
                                                                                    ...
                                                                                    OnClientClick="return confirm('Do you want to delete Family Member Details? ');" OnClick="img_del_all_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                    </Columns>
