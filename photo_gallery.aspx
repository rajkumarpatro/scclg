<%@ page title="Photo Gallery- Govt. V.Y.T. PG AUTONOMOUS COLLEGE,DURG" language="C#" masterpagefile="~/Home_Page.master" autoeventwireup="true" CodeFile="photo_gallery.aspx.cs" inherits="photo_gallery" %>
                                                ...
                                                <figure>
                                                    <a href='events_details.aspx?eid=<%= dr["event_id"] %>' target="_blank">
                                                        ...
                                                        <h6>                                                           
                                                                Date : <%= dr["event_date"]%>
                                                            <br>
                                                            <span style="line-height: 1.8em;"><a href="events_details.aspx?eid=<%= dr["event_id"] %>" style="color: #000;" target="_blank">Click here for details</a></span>
