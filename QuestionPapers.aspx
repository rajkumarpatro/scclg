<%@ Page Language="C#" MasterPageFile="~/Home_Page.master" AutoEventWireup="true"
    CodeFile="QuestionPapers.aspx.cs" Inherits="QuestionPapers" Title="Question Papers" %>
      ...
      <div class="container">
        <div class="section-content" style="min-height:600px;">
          ...
          <div class="row">
            <div class="col-md-12">
                <br />
                <h2><b>B.A. Part - I, II, III, B.Sc. Part - III, BCA Part - III</b></h2>
                <br />
                <div class="row" runat="server" id="dv_class" style="font-weight:bold; color:#000;">
                    <div class="col-lg-2">
                        Select Date
                       <asp:DropDownList ID="ddl_date" runat="server" CssClass="form-control" AutoPostBack="false" OnSelectedIndexChanged="ddl_date_SelectedIndexChanged">     <%--AutoPostBack="true"--%>                      
                       </asp:DropDownList>
                    </div>
                    <div class="col-lg-2" style="display:none;">
                        Select Class Type
                       <asp:DropDownList ID="ddl_admissionclasstype" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_admissionclasstype_SelectedIndexChanged" AutoPostBack="false"> <%--AutoPostBack="true"--%>
                    ...
                    <div class="col-lg-3" style="display:none;">
                        Select Class
                        <asp:DropDownList ID="ddl_admissionclass" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_admissionclass_SelectedIndexChanged" AutoPostBack="false"> <%--AutoPostBack="true"--%>
                        </asp:DropDownList>
                    </div>
                    <div class="col-lg-2" style="display:none;">
                        Select Semester<asp:Label ID="lbl_classtype" runat="server"></asp:Label>
