<%@ Page Title="Govt. V.Y.T. PG AUTONOMOUS COLLEGE,DURG" Language="C#" MasterPageFile="~/Home_Page.master" AutoEventWireup="true" CodeFile="scpage1.aspx.cs" Inherits="scpage1" %>
            ...
            <div class="row">
                ...
                <div class="element-size-100">
                    ...
                    <%-- <%
                        ...
                        DataTable dsUpdates = SqlHelper.ExecuteDataTable(Connection.My_Connection(), CommandType.Text, @"SELECT TBL_LATEST_UPDATE.NEWS_ID, TBL_LATEST_UPDATE.NEWS_TITLE, TBL_LATEST_UPDATE.NEWS_SECTION, TBL_LATEST_UPDATE.NEWS_FILEPATH, TBL_LATEST_UPDATE.NEWS_LINK, TBL_LATEST_UPDATE.NEWS_LINKTYPE, TBL_LATEST_NEWS_DEPARTMENT.DEPARTMENT_ID, TBL_SCD_PAGE.PAGE_NAME,  FORMAT(TBL_LATEST_UPDATE.NEWS_DATE,'dd-MM-yyyy') as NEWS_DATE
FROM (TBL_LATEST_UPDATE INNER JOIN TBL_LATEST_NEWS_DEPARTMENT ON TBL_LATEST_UPDATE.NEWS_ID = TBL_LATEST_NEWS_DEPARTMENT.NEWS_ID) INNER JOIN TBL_SCD_PAGE ON TBL_LATEST_NEWS_DEPARTMENT.DEPARTMENT_ID = TBL_SCD_PAGE.PAGE_ID WHERE TBL_SCD_PAGE.PAGE_NAME=@PAGE_NAME ORDER BY TBL_LATEST_UPDATE.NEWS_DATE DESC", sp_news);
            ...
            <%
                    ...
                    <div class="row">
                        ...
                        <%
                            ...
                            string str_query = @"SELECT TBL_SCD_PAGE.PAGE_ID, TBL_SCD_PAGE.PAGE_NAME, TBL_SCD_PAGE_TOPIC.TOPIC_ID, TBL_SCD_PAGE_TOPIC.TOPIC_NAME,IS_DEPARTMENT 
                        FROM TBL_SCD_PAGE INNER JOIN TBL_SCD_PAGE_TOPIC ON TBL_SCD_PAGE.PAGE_ID = TBL_SCD_PAGE_TOPIC.PAGE_ID where PAGE_NAME=@PAGE_NAME order by TOPIC_ID";
                        ...
                        <div class="<%= str_col_size %>" id="content_main">
                                        ...
                                        <div class="row">
                                            <%
                                                ...
                                                string str_pagedetails_query = @"SELECT TOP 1 TBL_SCD_PAGE.PAGE_ID, TBL_SCD_PAGE.PAGE_NAME, TBL_SCD_PAGE_TOPIC.TOPIC_ID, TBL_SCD_PAGE_TOPIC.TOPIC_NAME
                                                    ...
                                                    " + str_where + " ORDER BY TBL_SCD_PAGE_TOPIC.TOPIC_ID";
                         ...
                         TBL_SCD_PAGE_TOPIC ON TBL_SCD_PAGE_DETAIL.TOPIC_ID = TBL_SCD_PAGE_TOPIC.TOPIC_ID WHERE TBL_SCD_PAGE_TOPIC.TOPIC_ID=@TOPIC_ID ORDER BY TBL_SCD_PAGE_DETAIL.TOPIC_DATE desc,TBL_SCD_PAGE_DETAIL.SUB_TOPIC_ID desc";
            ...
            <% 
                                                    ...
                                                    <% 
                                                        ...
                                                        if (topic_name.ToString().ToUpper().Trim() == "STAFF")
                                                        {
                                                            ...
                                                            DataTable dt_Teaching_Staff = SqlHelper.ExecuteDataTable(Connection.My_Connection(), CommandType.Text, @"SELECT TBL_SCD_Faculty.faculty_id, TBL_SCD_Faculty.faculty_name, TBL_SCD_Faculty.faculty_qualification, TBL_SCD_Faculty.faculty_designation, 
TBL_SCD_Faculty.faculty_mobile, TBL_SCD_Faculty.faculty_type, TBL_SCD_Faculty.PAGE_ID, TBL_SCD_Faculty.faculty_order, TBL_SCD_Faculty.filepath, 
TBL_SCD_PAGE.PAGE_NAME FROM TBL_SCD_Faculty INNER JOIN TBL_SCD_PAGE ON TBL_SCD_Faculty.PAGE_ID = TBL_SCD_PAGE.PAGE_ID WHERE faculty_type=@faculty_type and TBL_SCD_PAGE.PAGE_NAME=@PAGE_NAME
ORDER BY faculty_order, TBL_SCD_Faculty.faculty_id", sp_faculty);
                                                    ...
                                                    <%    
                                                        ...
                                                        DataTable dt_Non_Teaching_Staff = SqlHelper.ExecuteDataTable(Connection.My_Connection(), CommandType.Text, @"SELECT TBL_SCD_Faculty.faculty_id, TBL_SCD_Faculty.faculty_name, TBL_SCD_Faculty.faculty_qualification, TBL_SCD_Faculty.faculty_designation, 
TBL_SCD_Faculty.faculty_mobile, TBL_SCD_Faculty.faculty_type, TBL_SCD_Faculty.PAGE_ID, TBL_SCD_Faculty.faculty_order, TBL_SCD_Faculty.filepath, 
TBL_SCD_PAGE.PAGE_NAME FROM TBL_SCD_Faculty INNER JOIN TBL_SCD_PAGE ON TBL_SCD_Faculty.PAGE_ID = TBL_SCD_PAGE.PAGE_ID WHERE faculty_type=@faculty_type and TBL_SCD_PAGE.PAGE_NAME=@PAGE_NAME
ORDER BY faculty_order, TBL_SCD_Faculty.faculty_id", sp_staff);
