<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="post_students_feedback_form.aspx.cs" EnableEventValidation="false" Inherits="students_feedback_form" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div  class="main-content">
             <div class="wrap-title-page">
					<div class="container">
						<div class="row">
							<div class="col-xs-12"><h1 class="ui-title-page">Feedback from Students About College </h1></div>
						</div>
					</div>
				</div>
                      </div>
     <div  class="container">
         ...
         <div class="row">
                <div class="col-md-8">
                    ...
                    <asp:GridView ID="s_feedback" runat="server" BackColor="White"  BorderColor="#3366CC" DataKeyNames="FEEDBACK_ID,COURSE_ID" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" AutoGenerateColumns="False" Width="1460px"  >
                                                                    <Columns>
