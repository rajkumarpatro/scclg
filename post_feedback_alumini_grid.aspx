<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="post_feedback_alumini_grid.aspx.cs" Inherits="post_feedback_alumini_grid" %>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label>
                                                                    Address of the Alumnus<span style="color:red;font-weight:600;">*</span>
                                                                     ...
                                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" runat="server" ErrorMessage="Please enter your name" ControlToValidate="txtaa" ValidationGroup="g1" Display="Dynamic" Text="Please Enter Father name"></asp:RequiredFieldValidator>
                                                             ...
                                                             <div class="row">
                                                                ...
                                                                <label>
                                                                 ...
                                                                 <div class="col-md-2">
                                                                        ...
                                                                        <asp:Button ID="btn_Save" runat="server" Text="Update" Class="btn btn-success" OnClick="btn_Save_Click" ValidationGroup="g1" />
