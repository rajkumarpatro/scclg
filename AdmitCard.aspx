<%@ Page Language="C#" MasterPageFile="~/Home_Page.master" AutoEventWireup="true" CodeFile="AdmitCard.aspx.cs" Inherits="AdmitCard" Title="Admit Card | Govt.V.Y.T.PG. Autonomous College, Durg" %>
...
<ContentTemplate>
 <div class="main-content">
    ...
    <div class="wrap-title-page">
					<div class="container">
						<div class="row">
							<div class="col-xs-12"><h1 class="ui-title-page">Admit Card</h1></div>
						</div>
					</div><!-- end container-->
        ...
        <div class="section-content">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
                 ...
                 &nbsp;
                <a href="scpage.aspx?PageName=Roll%20List">For Search Your Roll No. Click Here</a>
            </div> 
            <div class="row">
            <div class="col-md-12">
            &nbsp;
          ...
          <div class="row">
            ...
            <asp:GridView ID="gv_topic" runat="server" AutoGenerateColumns="False" 
                ...
                GridLines="Vertical" Width="100%"  
                    EmptyDataText="No Admit Card Found, Try With Another Roll Number">
                <Columns>
                    <asp:BoundField DataField="AcardRollNumber" HeaderText="Roll Number"/>
                    <asp:TemplateField HeaderText="Download">
                     <ItemTemplate>
                        <a href ='<%#""+DataBinder.Eval(Container.DataItem,"AcardPath") %>' style="color:Black;">
                        Click Here</a>
                     </ItemTemplate>
                </asp:TemplateField>
