<%@ Page Title="Post Data" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="post_science_data.aspx.cs" Inherits="post_science_data" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                ...
                <div class="element-size-100">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea id="txt_description" name="editordata" runat="server" ClientIDMode="Static"></textarea>
    ...
    <script>
        ...
        function UploadImage(file) {
            //debugger;
            var url = "UploadImage.asmx/UploadFile";
            ...
            $.ajax({
                ...
                success: function (FileUrl) {
                    ...
                    imgNode.src = FileUrl;
                    $("#txt_description").summernote("insertNode", imgNode);
                },
                error: function (msg) {
                    debugger;
                    //alert(msg);
